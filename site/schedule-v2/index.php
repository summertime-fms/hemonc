        ...
        <div class="relative">
          <div class="schedule-filters__subrow">
            <label class="schedule-filter">
              ...
              >
                <optgroup label="Терапия">
                  <option value="oncologist">Терапевт</option>
                  <option value="chemotherapist">Гастроэнтеролог</option>
                  <option value="mammologist">Кардиолог</option>
            ...
            <label class="schedule-filter">
              ...
              >
                <option value="breast-cancer">Артрит</option>
                <option value="lung-cancer">Язвенная болезнь желудка</option>
            ...
            <label class="schedule-filter">
              ...
              >
                <option value="primary-consultation">
        ...
        <div class="doctor-card__body">
          ...
          <div class="doctor-card__main-content">
            <div class="doctor-card__name">
              Рушниченко Анастасия Владимировна
            </div>
